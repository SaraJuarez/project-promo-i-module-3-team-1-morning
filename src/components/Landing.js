  ...
  return (
    <>
      <main className='main-landing'>
        ...
        <h3 className='main-landing__subtitle'>Crea mejores contactos profesionales de forma fácil y cómoda</h3>
        <section className='info'>
          <div className='info__icon-container'>
            <img className='info__icon' src={iconDesign} title='Diseña' alt='Icono de diseña' />
            <h5 className='info__text'>Diseña</h5>
          </div>
          <div className='info__icon-container'>
            <img className='info__icon' src={iconFill} title='Rellena' alt='Icono de rellena' />
            <h5 className='info__text'>Rellena</h5>
          </div>
          <div className='info__icon-container'>
            <img className='info__icon' src={iconShare} title='Comparte' alt='Icono de comparte' />
