  ...
  return (
    <form className="complete__form" action="#" method="post" id="myForm">
      ...
      <div className="complete__form__image-fields">
        <label for="photo" className="complete__form__image-fields__image-button-label">
          Añadir imagen
        </label>
      ...
      <label className="complete__form__label required" for="email">
        Email
      </label>
      ...
      <label className="complete__form__label" for="linkedin">
        Linkedin
      </label>
      ...
      <label className="complete__form__label" for="github">
        Github
      </label>
